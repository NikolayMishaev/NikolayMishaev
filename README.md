...
***
<details>
  <summary> Меня зовут Николай. В свой первый день знакомства с программированием, я написал игру на QBasic. Это было в 2001 году. Тогда я учился в школе и кодинг меня очень увлекал...<code>кликни для продолжения</code></summary>
